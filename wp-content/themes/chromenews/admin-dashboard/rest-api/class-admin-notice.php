...
class AdminNotice {
    ...
    function chromenews_dashboard_notice_content(){
		...
		$notice_starter_msg =sprintf(
			...
			__( 'General info', 'chromenews' ),
			esc_html__( 'All of the features provided by the theme are now ready to use; Here, we have gathered all of the essential details and helpful links for you and your better experience with the theme. Once again, Thanks for using our theme!', 'chromenews' ),
			$af_companion_url,
			$af_companion_title,
			esc_url($demo_link),
